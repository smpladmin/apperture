...
class Forward:
    @iterative_migration()
    async def name_to_title(self, input_document: OldMetric, output_document: Metric):
        aggregates = [
...
class Backward:
    @iterative_migration()
    async def name_to_title(self, input_document: Metric, output_document: OldMetric):
        aggregates = [
