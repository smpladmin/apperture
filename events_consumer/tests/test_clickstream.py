...
class TestClickStream:
    ...
    def test_build_null_element(self):
        """It should skip null values in $elements while building elements_chain"""
        ...
        result = ClickStream.build(
            ...
            properties={
                ...
                "$elements": [
                    ...
                    {
                        "tag_name": "span",
                        "classes": ["t4s-pr__icon-btn"],
                        "attr__class": "t4s-pr__icon-btn",
                        "nth_child": 1,
                        "nth_of_type": 1,
                    },
                    None,
                    {
                        "tag_name": "div",
                        "classes": ["t4s-pr-group-btns", "t4s-pa", "t4s-op-0"],
                        "attr__data-t4s-group-btns": "template--19108915708185__main",
                        "attr__class": "t4s-pr-group-btns t4s-pa t4s-op-0",
                        "nth_child": 4,
                        "nth_of_type": 3,
                    },
                ],
        ...
        assert result == ClickStream(
            ...
            datetime.fromtimestamp(1628607047.37),
            "test_user_id",
            'svg:nth-child="1"nth-of-type="1";span.t4s-pr__icon-btn:nth-child="1"nth-of-type="1";div.t4s-op-0.t4s-pa.t4s-pr-group-btns:nth-child="4"nth-of-type="3"',
            "$autocapture",
            {
                "$browser": "Chrome",
                "$browser_language": "en-GB",
