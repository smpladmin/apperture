...
const Home = (props: { tests: Array<{ id: string; name: string }> }) => {
  ...
  return (
    <div>
      ...
      <div>
        <h2>Testing Apperture | MVP</h2>
        <p>This data came from the backend and was rendered on the server</p>
        <div>
          {props.tests.map((t) => {
            return (
              <p key={t.id}>
      ...
      <div>
        <p>This data came from the backend and was rendered on the browser</p>
        <div>
          {testsV2.map((t) => {
            return (
              <p key={t.id}>
