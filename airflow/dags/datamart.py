...
logging.info(f"Fetched datamart_actions: {datamart_actions}")
...
logging.info(f"dependent_dags_map: {dependent_dags_map}")
logging.info(f"datamart_actions_filtered: {datamart_actions_filtered}")
for datamart_action in datamart_actions_filtered:
    ...
    logging.info(f"key to search in dependent_dags_map: {datamart_action.datasource_id}$${datamart_action.datamart_id}")
    logging.info(f"create_dag([datamart_action] + dependent_dags): {[datamart_action]} + {dependent_dags}")
